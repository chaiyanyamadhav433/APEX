...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(184556744586762201)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(184557059177762201)
,p_plug_template_id=>wwv_flow_api.id(184556744586762201)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(184557324649762201)
,p_plug_template_id=>wwv_flow_api.id(184556744586762201)
,p_name=>'Sub Regions'
