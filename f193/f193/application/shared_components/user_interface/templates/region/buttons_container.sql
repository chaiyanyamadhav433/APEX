...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(184546358458762190)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(184546603419762191)
,p_plug_template_id=>wwv_flow_api.id(184546358458762190)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(184546902941762191)
,p_plug_template_id=>wwv_flow_api.id(184546358458762190)
,p_name=>'Sub Regions'
