...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(184583157368762226)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(184583485668762227)
,p_plug_template_id=>wwv_flow_api.id(184583157368762226)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(184583766805762227)
,p_plug_template_id=>wwv_flow_api.id(184583157368762226)
,p_name=>'Tabs'
