...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(184576335382762219)
,p_layout=>'TABLE'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(184576643806762220)
,p_plug_template_id=>wwv_flow_api.id(184576335382762219)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_api.create_plug_tmpl_display_point(
 p_id=>wwv_flow_api.id(184576918506762220)
,p_plug_template_id=>wwv_flow_api.id(184576335382762219)
,p_name=>'Sub Regions'
